                ...
                <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  <div>
                    ...
                    <div style={{ position: 'relative' }}>
                      <span className="material-symbols-outlined shrink-0" style={{ position: 'absolute', left: '12px', top: '50%', transform: 'translateY(-50%)', fontSize: '18px', color: 'rgba(100,116,139,0.5)' }}>mail</span>
                      <input
                  ...
                  <div>
                    ...
                    <div style={{ position: 'relative' }}>
                      <span className="material-symbols-outlined shrink-0" style={{ position: 'absolute', left: '12px', top: '50%', transform: 'translateY(-50%)', fontSize: '18px', color: 'rgba(100,116,139,0.5)' }}>lock</span>
                      <input
                  ...
                  <button type="submit" disabled={loading} className="btn-primary" style={{ width: '100%', padding: '12px', justifyContent: 'center', display: 'flex', alignItems: 'center', gap: '8px' }}>
                    {loading ? (
                      <><span className="material-symbols-outlined shrink-0 animate-spin" style={{ fontSize: '18px' }}>refresh</span><span>Signing in...</span></>
                    ) : (
                      <><span>Sign In</span> <span className="material-symbols-outlined shrink-0" style={{ fontSize: '18px' }}>arrow_forward</span></>
                    )}
                  </button>
                </form>
                ...
                <form onSubmit={handleSignup} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  {[
                    ...
                    <div key={field.label}>
                      ...
                      <div style={{ position: 'relative' }}>
                        <span className="material-symbols-outlined shrink-0" style={{ position: 'absolute', left: '12px', top: '50%', transform: 'translateY(-50%)', fontSize: '18px', color: 'rgba(100,116,139,0.5)' }}>{field.icon}</span>
                        <input
